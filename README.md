...
### 📃 배경
```
✔ 코로나 19의 장기화로 인해 온라인 활동이 지속되고 있던 와중에 확산세가 점차 줄어들게 됨으로써 오프라인 활동으로다시 전환되고 있는 추세입니다.

✔ 오프라인 활동의 증가로 인해 대학생이나 직장인 등 혼자 사는 1인 가구가 늘어나고 자취를 처음하는 사람들은 자취 시작 전 고려사향 등에 관한 고민이 있을테고
그러한 고민을 해결하기 위해서 여러 방면으로 검색을 할 것입니다.
...
<img src="https://user-images.githubusercontent.com/94892374/184832672-a2cb2b31-eaa6-42f6-9ff7-efb7baec372f.png" width="800" height="600"/>

나혼자 잘산다 서비스는 반응형 서비스로, 웹/태블릿/휴대폰 등 **다양한 기기에서 접속** 하여 사용이 가능합니다. 

### **1. 메인 페이지** 

<img src="https://user-images.githubusercontent.com/94892374/184839684-9e72a100-3c94-4f3b-bb7f-93cd0ea3628b.gif" width="800" height="600">

"나혼자잘산다"의 메인화면 입니다. 사용자들이 가장 많이 본 꿀팁과 자신이 설정한 지역에서의 핫한 꿀딜 리스트를 볼 수 있습니다.
...
```
"나혼자잘산다"의 꿀팁 페이지 입니다.
꿀시피/꿀생/꿀템 총 3가지 페이지로 구성되어 있고, 나의 자취 노하우를 공유하고 상대방의 자취 노하우를 확인할 수 있습니다.
SNS 서비스 인만큼 사용자를 팔로우할 수도 있습니다.
```
...
거래를 원하는 게시글 작성자와 거래하기 좋은 중간위치를 조회할 수 있으며 댓글을 통해 자신의 물건과 교환을 요청할 수 있습니다.
```
...
|팀원|느낀점|
|-----|---|
|김혜진|K(Keep) : 하루에 두 번 이상 회의를 함으로써 백-프론트 간 서로 진행사항을 공유할 수 있어서 좋았다. MyBatis 대신 JPA를 처음 써보았는데 처음엔 어려웠지만 기존의 방식보다 훨씬 편하고 구현도 간단하다고 느꼈고, 다음에도 JPA를 사용하여 프로젝트를 기획하고 싶다. P(Problem) : 초기에 자동배포를 하지 않아서 서버를 초기화하는 등 배포에 대한 여러움이 있었다. 또한 프로젝트를 하기 전에 시간에 쫓기지 않기 위해서
나름 구체적으로 계획을 세웠는데 계획한 대로 진행되지 않았다. T(Try) : 일정에 차질이 생기고 문제가 발생하더라도 팀원들끼리 의기투합하여 하나하나 해결해나갔다.다음 프로젝트를 할 때에는 자동배포에 대해 학습의 필요성을 느꼈다.|
|정지원|내용|
|최 강|내용|
